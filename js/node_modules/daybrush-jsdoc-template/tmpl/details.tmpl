...
<dl class="details">
    ...
    <dd class="tag-since">
        <ul class="dummy"><li>
            <?js if(env.conf?.docdash?.repo) {?>
                <a href="https://github.com/<?js=env.conf.docdash.repo?>/releases/tag/<?js= since ?>" target="_blank"><?js= since ?></a>
            <?js } else { ?>
                <?js= since ?>
            <?js } ?>
        </li></ul>
    ...
    <?js } ?>
    <?js if (data.story) {?>
    <dt class="tag-story">Story Example:</dt>
    <dd class="tag-story">
        <ul class="dummy"><li>
            <a href="<?js=data.story.url?>" target="_blank"><?js= data.story.title ?></a>
        </li></ul>
    </dd>
    <?js } ?>
